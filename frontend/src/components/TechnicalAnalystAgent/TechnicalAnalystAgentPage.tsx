...
const TechnicalAnalystAgentPage: React.FC = () => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      type: 'ai',
      message:
        "Hello. I am the Technical Analyst Agent. I can help you with chart patterns, indicators, and trade setups.",
      timestamp: new Date()
    }
  ]);
  ...
  const getAssistantReply = async (question: string): Promise<string> => {
    if (apiBaseUrl) {
      try {
        const res = await fetch(`${apiBaseUrl}/chat`, {
          ...
          body: JSON.stringify({ question, agent: 'technical-analyst' })
        });
    ...
    return "I am analyzing the charts based on your request. Please specify the timeframe and asset you are interested in.";
  };
    ...
    setMessages([
      {
        id: 'welcome',
        type: 'ai',
        message: "Hello. I am the Technical Analyst Agent. I can help you with chart patterns, indicators, and trade setups.",
        timestamp: new Date()
      }
    ]);
    setDraft('');
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2">
          ...
          <button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-300 hover:bg-white/5 rounded-lg transition-colors text-left truncate">
            <span className="truncate">Chart Analysis</span>
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <div className="h-14 flex items-center justify-between px-4 border-b border-white/5 bg-ink-950/50 backdrop-blur z-10">
          <div className="flex items-center gap-2">
            ...
            <div className="font-semibold text-gray-200">Technical Analyst Agent</div>
            ...
            {isTyping && (
              <div className="w-full px-4 py-6">
                <div className="flex gap-4 max-w-3xl mx-auto">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-semibold text-sm text-gray-200 mb-1">Technical Analyst</div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative flex items-end gap-2 bg-ink-800/80 backdrop-blur border border-white/10 rounded-2xl p-3 shadow-lg focus-within:border-gold-500/30 focus-within:ring-1 focus-within:ring-gold-500/30 transition-all">
              ...
              <textarea
                ...
                rows={1}
                placeholder="Message Technical Analyst..."
...
export default TechnicalAnalystAgentPage;
