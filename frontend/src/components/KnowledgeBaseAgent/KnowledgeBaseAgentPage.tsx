...
const KnowledgeBaseAgentPage: React.FC = () => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      type: 'ai',
      message:
        "Hello. I am the Knowledge Base Agent. I can help you search and summarize your documents and internal knowledge.",
      timestamp: new Date()
    }
  ]);
  ...
  const getAssistantReply = async (question: string): Promise<string> => {
    if (apiBaseUrl) {
      try {
        const res = await fetch(`${apiBaseUrl}/chat`, {
          ...
          body: JSON.stringify({ question, agent: 'knowledge-base' })
        });
    ...
    return "I am searching the knowledge base for relevant information. Please provide keywords or specific document names if possible.";
  };
    ...
    setMessages([
      {
        id: 'welcome',
        type: 'ai',
        message: "Hello. I am the Knowledge Base Agent. I can help you search and summarize your documents and internal knowledge.",
        timestamp: new Date()
      }
    ]);
    setDraft('');
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <div className="h-14 flex items-center justify-between px-4 border-b border-white/5 bg-ink-950/50 backdrop-blur z-10">
          <div className="flex items-center gap-2">
            ...
            <div className="font-semibold text-gray-200">Knowledge Base Agent</div>
            ...
            {isTyping && (
              <div className="w-full px-4 py-6">
                <div className="flex gap-4 max-w-3xl mx-auto">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-semibold text-sm text-gray-200 mb-1">Knowledge Base</div>
...
export default KnowledgeBaseAgentPage;
